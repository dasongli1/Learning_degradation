...
from basicsr.models.archs.architecture import VGG19
...
class VGGLoss2(nn.Module):
    def __init__(self, gpu_ids):
        ...
        self.vgg = VGG19().cuda()
        self.criterion = nn.L1Loss()
        self.weights = [1.0 / 8, 1.0 / 4, 1.0, 1.0 / 4, 1.0 / 8] 
        print("using VGG loss2: --- 1.0 / 8, 1.0 / 4, 1.0, 1.0 / 4, 1.0 / 8")
        # self.weights = [1.0 / 16.0, 1.0 / 8.0, 1.0 / 4,  1.0]
